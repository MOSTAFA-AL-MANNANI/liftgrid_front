...
import { FaRegEnvelope, FaUserShield } from "react-icons/fa";
...
export default function VerifyCode() {
  ...
  const handleResendCode = async () => {
    ...
    try {
      await api.post("/resend-reset-code", { email });
      setTimer(300);
      setCanResend(false);
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                Vérification de <br />
                <span className="text-black">sécurité</span>
              </h1>
            ...
            <div className="space-y-4">
              {[
                { icon: <FiShield />, text: "Code valide pendant 5 minutes" },
                { icon: <FiMail />, text: "Vérifiez vos spams si nécessaire" },
                { icon: <MdSecurity />, text: "Ne partagez jamais ce code" },
                { icon: <FiLock />, text: "Sécurité à deux facteurs activée" }
              ].map((tip, index) => (
                <motion.div
                  key={index}
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="text-center mb-8">
              <div className="w-16 h-16 bg-gradient-to-br from-[#ffb000]/20 to-yellow-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <MdOutlineVerified className="w-8 h-8 text-[#ffb000]" />
              </div>
              ...
              <p className="text-sm text-gray-500">
                Envoyé à {localStorage.getItem("resetEmail")?.slice(0, 3)}***@***
              </p>
            </div>
              ...
              <div className="flex justify-center gap-2 md:gap-2">
                {code.map((digit, index) => (
                  <motion.input
                    ...
                    className="w-10 h-10 md:w-14 md:h-14 text-center text-2xl font-bold border-2 border-gray-300 rounded-xl focus:border-[#ffb000] focus:ring-2 focus:ring-[#ffb000]/30 transition-all duration-200 outline-none bg-gray-50"
                  />
                ))}
              </div>
              ...
              <div className="text-center">
                <button
                  ...
                  className={`inline-flex items-center gap-2 text-sm font-medium ${
                    canResend
                      ? "text-[#ffb000] hover:text-yellow-600"
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <button className="text-sm text-gray-600 hover:text-[#ffb000] transition-colors flex items-center justify-center gap-2">
                  ...
                  <Link
                    ...
                    className="text-sm text-[#ffb000] hover:text-yellow-600 transition-colors flex items-center justify-center gap-2"
                  >
