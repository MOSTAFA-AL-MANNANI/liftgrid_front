  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (rememberMe) {
        ...
        sessionStorage.setItem("companyToken", res.data.token);
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div>
              <Link to="/" className="inline-flex items-center gap-3 mb-8 group">
                <div className="w-12 h-12 bg-white backdrop-blur-sm rounded-2xl flex items-center justify-center">
                  <img src="/logo.png" alt="LiftGrid Logo" className="w-8 h-8" />
                </div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                Connectez votre <br />
                <span className="text-black">entreprise</span>
              </h1>
              <p className="text-white/90 text-lg mb-8">
                Gérez vos caristes et optimisez vos opérations logistiques en toute simplicité
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                { icon: <MdOutlineWorkspacePremium />, text: "Accès aux meilleurs caristes certifiés" },
                { icon: <FaChartLine />, text: "Analyses détaillées de vos opérations" },
                { icon: <FaHandshake />, text: "Gestion simplifiée des contrats" },
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="text-center mb-8">
              <div className="w-16 h-16 bg-gradient-to-br from-[#ffb000]/20 to-yellow-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <MdOutlineWorkspacePremium className="w-8 h-8 text-[#ffb000]" />
              </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-[#ffb000] to-yellow-500 text-white font-semibold py-3.5 px-6 rounded-xl hover:shadow-lg hover:shadow-[#ffb000]/30 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
